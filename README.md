...
- Find processes using a file by name or path through **Find file users** in the header, then open the owner's Files tab. Search reports include partial-coverage information.
